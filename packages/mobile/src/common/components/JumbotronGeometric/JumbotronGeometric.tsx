...
>({
  ...
  function validateBGColor() {
    switch (bgColor) {
      case "white": {
        return require("../../../../assets/bg-geometric/white.png") as ImageSourcePropType;
      }
      case "blue": {
        return require("../../../../assets/bg-geometric/blue.png") as ImageSourcePropType;
      }
      case "lightblue": {
        return require("../../../../assets/bg-geometric/lightblue.png") as ImageSourcePropType;
      }
      default: {
        return require("../../../../assets/bg-geometric/blue.png") as ImageSourcePropType;
      }
  ...
  return (
    <ImageBackground source={validateBGColor()} resizeMode="cover">
      ...
      >
        ...
        {text && (
          <Text fontFamily="mono" color={fontColor("caption")} fontSize={18}>
            {text}
          </Text>
        )}
      </Box>
